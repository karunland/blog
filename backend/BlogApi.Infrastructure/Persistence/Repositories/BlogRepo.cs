    ...
    IMemoryCache _cache)
{
    ...
    public async Task<ApiResult> Create(BlogAddRequest blog)
    {
        ...
        var emailMessage = new EmailMessage
        {
            ...
            Body = $"'{blog.Title}' başlıklı blog yazın başarıyla oluşturuldu."
        };
    ...
    {
        var blogToDelete = await _context.Blogs
            .FirstOrDefaultAsync(x => x.Slug == slug && (x.UserId == _currentUserService.Id || _currentUserService.Email == "1harunkorkmaz@gmail.com"));
